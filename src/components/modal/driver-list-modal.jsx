...
export default function DriverListModal({ open, setOpen }) {
  return (
            ...
            <div className="bg-white   px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div className="mt-5 ">
                <div className="flex flex-col  ">
                  <label className="font-inter text-sm">Driver Name</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col my-5  ">
                  <label className="font-inter text-sm">License Number</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col my-5  ">
                  <label className="font-inter text-sm">Birth date</label>
                  <input
                    type="date"
                    placeholder="Enter license number"
                    className="border-1 outline-none p-3 rounded-lg mt-2 "
